...
# NOTE: Trading logic has been moved to kucoin-lane (Lane 4). This file
# retains governance-related config only. API credentials are now env-vars.
...
TRADING_CONFIG = {
    ...
    "trading_pairs": [
        ...
        "BTC/USDT",
        "ETH/USDT",
    ],  # Multi-asset with asset-specific tuning
}
...
# KuCoin API Credentials — MOVED to kucoin-lane (Lane 4) environment variables
# DO NOT store credentials in source code. See kucoin-lane/config/.env.example
API_CONFIG = {
